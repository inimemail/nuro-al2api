...
export async function initializeConfig(args = process.argv.slice(2), configFilePath = 'configs/config.json') {
    const defaultConfig = {
        ...
        KIRO_CONTEXT_COMPRESSION_ENABLED: true,
        KIRO_CONTEXT_COMPRESSION_THRESHOLD_TOKENS: 160000,
        KIRO_CONTEXT_COMPRESSION_TARGET_TOKENS: 140000,
        KIRO_CONTEXT_COMPRESSION_KEEP_RECENT_MESSAGES: 8,
        KIRO_CONTEXT_COMPRESSION_MAX_SUMMARY_TOKENS: 12000,
        KIRO_CONTEXT_COMPRESSION_MESSAGE_CHARS: 1200,
    ...
    const cliArgDefs = [
        ...
        { flag: '--kiro-context-compression-enabled', configKey: 'KIRO_CONTEXT_COMPRESSION_ENABLED', type: 'bool' },
        { flag: '--kiro-context-compression-threshold-tokens', configKey: 'KIRO_CONTEXT_COMPRESSION_THRESHOLD_TOKENS', type: 'int' },
        { flag: '--kiro-context-compression-target-tokens', configKey: 'KIRO_CONTEXT_COMPRESSION_TARGET_TOKENS', type: 'int' },
        { flag: '--kiro-context-compression-keep-recent-messages', configKey: 'KIRO_CONTEXT_COMPRESSION_KEEP_RECENT_MESSAGES', type: 'int' },
        { flag: '--kiro-context-compression-max-summary-tokens', configKey: 'KIRO_CONTEXT_COMPRESSION_MAX_SUMMARY_TOKENS', type: 'int' },
        { flag: '--kiro-context-compression-message-chars', configKey: 'KIRO_CONTEXT_COMPRESSION_MESSAGE_CHARS', type: 'int' },
    ...
    currentConfig.SYSTEM_PROMPT_CONTENT = currentConfig.SYSTEM_PROMPT_FILE_PATH
        ? await getSystemPromptFileContent(currentConfig.SYSTEM_PROMPT_FILE_PATH)
        : null;
