...
DEFAULT_GEMINI_OAUTH_CLIENT_ID="681255809395-oo8ft2oprdrnp9e3aqf6av3hmdib135j.apps.googleusercontent.com"
DEFAULT_GEMINI_OAUTH_CLIENT_SECRET="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"
DEFAULT_ANTIGRAVITY_OAUTH_CLIENT_ID="1071006060591-tmhssin2h21lcre235vtolojh4g403ep.apps.googleusercontent.com"
DEFAULT_ANTIGRAVITY_OAUTH_CLIENT_SECRET="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"
...
PORT=${host_port}
TZ=Asia/Shanghai
GEMINI_OAUTH_CLIENT_ID=${GEMINI_OAUTH_CLIENT_ID:-$DEFAULT_GEMINI_OAUTH_CLIENT_ID}
GEMINI_OAUTH_CLIENT_SECRET=${GEMINI_OAUTH_CLIENT_SECRET:-$DEFAULT_GEMINI_OAUTH_CLIENT_SECRET}
ANTIGRAVITY_OAUTH_CLIENT_ID=${ANTIGRAVITY_OAUTH_CLIENT_ID:-$DEFAULT_ANTIGRAVITY_OAUTH_CLIENT_ID}
ANTIGRAVITY_OAUTH_CLIENT_SECRET=${ANTIGRAVITY_OAUTH_CLIENT_SECRET:-$DEFAULT_ANTIGRAVITY_OAUTH_CLIENT_SECRET}
ARGS=
EOF
