...
async function loadConfiguration() {
    try {
        ...
        if (systemPromptFilePathEl) systemPromptFilePathEl.value = data.SYSTEM_PROMPT_FILE_PATH || '';
...
async function saveConfiguration(options = {}) {
    ...
    // 保存高级配置参数
    config.SYSTEM_PROMPT_FILE_PATH = document.getElementById('systemPromptFilePath')?.value?.trim() || null;
