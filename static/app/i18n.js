...
const translations = {
    'zh-CN': {
        ...
        'oauth.kiro.iamSso': 'IAM Identity Center（企业 SSO）登录',
        'oauth.kiro.iamSsoDesc': '通过 IAM Identity Center 授权添加企业账号',
        'oauth.kiro.identityCenterStartURL': 'IAM Identity Center Start URL',
        'oauth.kiro.identityCenterStartURLHint': '请输入企业 IAM Identity Center 门户的 Start URL，通常形如 https://xxx.awsapps.com/start',
        'oauth.kiro.identityCenterStartURLRequired': '请输入 IAM Identity Center Start URL',
        'oauth.kiro.identityCenterRegion': 'IAM Identity Center Region',
        'oauth.kiro.profileArn': 'Kiro Profile ARN',
        'oauth.kiro.profileArnHint': '企业 SSO 通常需要 Profile ARN，可在 Kiro / AWS Q Developer 的企业配置或缓存中获取',
        'oauth.kiro.profileArnInvalid': 'Profile ARN 格式不正确',
        'oauth.kiro.startIdentityCenterAuth': '开始企业 SSO 授权',
        ...
        'config.advanced.systemPromptFilePlaceholder': '留空则禁用系统提示文件',
        ...
        'usage.balance.available': '账户可用',
        'usage.balance.unavailable': '账户不可用',
        'usage.balance.granted': '赠送余额',
    ...
    'en-US': {
        ...
        'oauth.kiro.iamSso': 'IAM Identity Center (Enterprise SSO) Login',
        'oauth.kiro.iamSsoDesc': 'Authorize and add an enterprise account with IAM Identity Center',
        'oauth.kiro.identityCenterStartURL': 'IAM Identity Center Start URL',
        'oauth.kiro.identityCenterStartURLHint': 'Enter your enterprise IAM Identity Center portal Start URL, usually like https://xxx.awsapps.com/start',
        'oauth.kiro.identityCenterStartURLRequired': 'Enter the IAM Identity Center Start URL',
        'oauth.kiro.identityCenterRegion': 'IAM Identity Center Region',
        'oauth.kiro.profileArn': 'Kiro Profile ARN',
        'oauth.kiro.profileArnHint': 'Enterprise SSO usually needs a Profile ARN from Kiro / AWS Q Developer enterprise settings or cache',
        'oauth.kiro.profileArnInvalid': 'Invalid Profile ARN format',
        'oauth.kiro.startIdentityCenterAuth': 'Start Enterprise SSO Auth',
        ...
        'config.advanced.systemPromptFilePlaceholder': 'Leave empty to disable system prompt file',
        ...
        'usage.balance.available': 'Account available',
        'usage.balance.unavailable': 'Account unavailable',
        'usage.balance.granted': 'Granted balance',
        'usage.balance.toppedUp': 'Topped-up balance',
